...
const RECEIVER = "erd1k5m2nv508ekzkxt3kcnpy8fel50p2q9nvvtp50ey3lalc2mpnw0qsvw5q4"
const FUNCTION = "changeRewardsRecipient";
const CHAIN_ID = "D";
...
async function changeRewardsRecipient(
    signer: UserSigner,
    receiver: Address,
  ): Promise<void> {  
...
async function main() {
    try {
      ...
      await changeRewardsRecipient(signer, Address.fromBech32(RECEIVER));
